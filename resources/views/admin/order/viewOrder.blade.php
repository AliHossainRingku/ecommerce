...
@section('admin_content')
    ...
    <div class="col-sm-6">
        <table class="table table-bordered">
            ...
            <tr>
                <th>Date</th><td>{{$order->created_at}}</td>
            </tr>
            <tr>
    ...
    <div class="col-sm-12">
        <table class="table table-striped table-bordered" border="1px">
            ...
            <div id="order_confirmation">
                ...
                <a href="{{ URL::to('/confirm-order/'.$order->order_id) }}" class="btn btn-success pull-right">Confirm</a>
                <a href="{{ URL::to('/edit-order/'.$order->order_id) }}" class="btn btn-primary pull-right">Edit</a>
                <a href="{{ URL::to('/delete-order/'.$order->order_id) }}" class="btn btn-warning pull-right">Delete</a>
